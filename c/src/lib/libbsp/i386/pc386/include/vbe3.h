...
#define VBE_callSuccessful           0x00  /* AH == 00h: Function call successful */
#define VBE_callFailed               0x01  /* AH == 01h: Function call failed */
#define VBE_notSupportedInCurHWConf  0x02  /* AH == 02h: Function is not supported in the current hardware configuration */
#define VBE_callInvalid              0x03  /* AH == 03h: Function call invalid in current video mode */

/* VBE Mode Numbers */
#define VBE_modeNumberMask         0x01FF  /* D0-D8 =  Mode number */
#define VBE_modeNumberShift          0x00 
#define VBE_VESAmodeMask           0x0100  /* If D8 == 0, this is not a VESA defined VBE mode */
#define VBE_VESAmodeShift            0x08  /* If D8 == 1, this is a VESA defined VBE mode */
                                           /* D9-D12 =  Reserved by VESA for future expansion (= 0) */
#define VBE_refreshRateCtrlMask    0x0800  /* If D11 == 0, Use current BIOS default refresh rate */
#define VBE_refreshRateCtrlShift     0x0B  /* If D11 == 1, Use user specified CRTC values for refresh rate */
                                           /* D12-13 = Reserved for VBE/AF (must be 0) */
#define VBE_linearFlatFrameBufMask 0x4000  /* If D14 == 0, Use Banked/Windowed Frame Buffer */
#define VBE_linearFlatFrameBufShift  0x0E  /* If D14 == 1, Use Linear/Flat Frame Buffer */
#define VBE_preserveDispMemMask    0x8000  /* If D15 == 0, Clear display memory */
#define VBE_preserveDispMemShift     0x0F  /* If D15 == 1, Preserve display memory */

/* Graphics modes */
#define VBE_R640x400C256      0x100    /* 15-bit mode, Resolution: 640x400, Colors: 256  */
#define VBE_R640x480C256      0x101    /* 15-bit mode, Resolution: 640x480, Colors: 256  */
#define VBE_R800x600C16       0x102    /* 15-bit mode, Resolution: 800x600, Colors: 16  */
#define VBE_b7R800x600C16     0x6A     /* 7-bit mode, Resolution: 800x600, Colors: 16  */
#define VBE_R800x600C256      0x103    /* 15-bit mode, Resolution: 800x600, Colors: 256  */
#define VBE_R1024x768C16      0x104    /* 15-bit mode, Resolution: 1024x768, Colors: 16  */
#define VBE_R1024x768C256     0x105    /* 15-bit mode, Resolution: 1024x768, Colors: 256  */
#define VBE_R1280x1024C16     0x106    /* 15-bit mode, Resolution: 1280x1024, Colors: 16  */
#define VBE_R1280x1024C256    0x107    /* 15-bit mode, Resolution: 1280x1024, Colors: 256  */
#define VBE_R320x200C32K      0x10D    /* 15-bit mode, Resolution: 320x200, Colors: 32K (1:5:5:5) */
#define VBE_R320x200C64K      0x10E    /* 15-bit mode, Resolution: 320x200, Colors: 64K (5:6:5) */
#define VBE_R320x200C17M      0x10F    /* 15-bit mode, Resolution: 320x200, Colors: 16.8M (8:8:8) */
#define VBE_R640x480C32K      0x110    /* 15-bit mode, Resolution: 640x480, Colors: 32K (1:5:5:5) */
#define VBE_R640x480C64K      0x111    /* 15-bit mode, Resolution: 640x480, Colors: 64K (5:6:5) */
#define VBE_R640x480C17M      0x112    /* 15-bit mode, Resolution: 640x480, Colors: 16.8M (8:8:8) */
#define VBE_R800x600C32K      0x113    /* 15-bit mode, Resolution: 800x600, Colors: 32K (1:5:5:5) */
#define VBE_R800x600C64K      0x114    /* 15-bit mode, Resolution: 800x600, Colors: 64K (5:6:5) */
#define VBE_R800x600C17M      0x115    /* 15-bit mode, Resolution: 800x600, Colors: 16.8M (8:8:8) */
#define VBE_R1024x768C32K     0x116    /* 15-bit mode, Resolution: 1024x768, Colors: 32K (1:5:5:5) */
#define VBE_R1024x768C64K     0x117    /* 15-bit mode, Resolution: 1024x768, Colors: 64K (5:6:5) */
#define VBE_R1024x768C17M     0x118    /* 15-bit mode, Resolution: 1024x768, Colors: 16.8M (8:8:8) */
#define VBE_R1280x1024C32K    0x119    /* 15-bit mode, Resolution: 1280x1024, Colors: 32K (1:5:5:5) */
#define VBE_R1280x1024C64K    0x11A    /* 15-bit mode, Resolution: 1280x1024, Colors: 64K (5:6:5) */
#define VBE_R1280x1024C17M    0x11B    /* 15-bit mode, Resolution: 1280x1024, Colors: 16.8M (8:8:8) */
...
struct VBE_SupVbeInfoBlock {
    ...
    uint8_t  *OemProductRevPtr;      /*  VbeFarPtr to Product Revision String */
    uint8_t  *OemStringPtr;          /*  VbeFarPtr to OEM String */
    uint8_t   Reserved[221];         /*  Reserved for description strings and future */
    /*  expansion */
} __attribute__((__packed__)) ; 


/* VbeInfoBlock Capabilities */
#define VBE_DACswitchableMask     0x0001 /*  D0 = 0  DAC is fixed width, with 6 bits per primary color */
                                         /*     = 1 DAC width is switchable to 8 bits per primary color */
#define VBE_notVGAcompatibleMask  0x0002 /*  D1 = 0 Controller is VGA compatible */
                                         /*     = 1 Controller is not VGA compatible */
#define VBE_specialRAMDACopMask   0x0004 /*  D2 = 0 Normal RAMDAC operation */
                                         /*     = 1 When programming large blocks of information to the RAMDAC, use the blank bit in Function 09h. */
#define VBE_hwStereoscopicMask    0x0008 /*  D3 = 0 No hardware stereoscopic signaling support */
                                         /*     = 1 Hardware stereoscopic signaling supported by controller */
#define VBE_supportEVCconnMask    0x0010 /*  D4 = 0 Stereo signaling supported via external VESA stereo connector */
                                         /*     = 1 Stereo signaling supported via VESA EVC connector */
                                         /*  D5-31 = Reserved */

/* ModeInfoBlock ModeAttributes */
#define VBE_modSupInHWMask        0x0001 /*  D0 =  Mode supported by hardware configuration */
                                         /*   0 =  Mode not supported in hardware */
                                         /*   1 =  Mode supported in hardware */
                                         /*  D1 =  1 (Reserved) */
#define VBE_TTYOutSupByBIOSMask   0x0004 /*  D2 =  TTY Output functions supported by BIOS */
                                         /*   0 =  TTY Output functions not supported by BIOS */
                                         /*   1 =  TTY Output functions supported by BIOS */
#define VBE_ColorModeMask         0x0008 /*  D3 =  Monochrome/color mode (see note below) */
                                         /*   0 =  Monochrome mode */
                                         /*   1 =  Color mode */
#define VBE_GraphicsModeMask      0x0010 /*  D4 =  Mode type */
                                         /*   0 =  Text mode */
                                         /*   1 =  Graphics mode */
#define VBE_VGACompModeMask       0x0020 /*  D5 =  VGA compatible mode */
                                         /*   0 =  Yes */
                                         /*   1 =  No */
#define VBE_VGACompWinMemModeMask 0x0040 /*  D6 =  VGA compatible windowed memory mode is available */
                                         /*   0 =  Yes */
                                         /*   1 =  No */
#define VBE_LinFraBufModeAvaiMask 0x0080 /*  D7 =  Linear frame buffer mode is available */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
#define VBE_DblScnModeAvaiMask    0x0100 /*  D8 =  Double scan mode is available */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
#define VBE_InterlModeAvaiMask    0x0200 /*  D9 =  Interlaced mode is available */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
#define VBE_HWTripBufSupMask      0x0400 /*  D10 =  Hardware triple buffering support */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
#define VBE_HWSterDispSupMask     0x0800 /*  D11 =  Hardware stereoscopic display support */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
#define VBE_DualDispStAdrSupMask  0x1000 /*  D12 =  Dual display start address support */
                                         /*   0 =  No */
                                         /*   1 =  Yes */
                                         /*  D13-D15 =  Reserved */

/* ModeInfoBlock WinXAttributes */
#define VBE_RelocWinSupMask       0x01   /*  D0 =  Relocatable window(s) supported */
                                         /*   0 =  Single non-relocatable window only */
                                         /*   1 =  Relocatable window(s) are supported */
#define VBE_WinReadableMask       0x02   /*  D1 =  Window readable */
                                         /*   0 =  Window is not readable */
                                         /*   1 =  Window is readable */
#define VBE_WinWritableMask       0x04   /*  D2 =  Window writeable */
...
#define VBE_ColRampProgMask       0x01   /*  D0 =  Color ramp is fixed/programmable */
                                         /*   0 =  Color ramp is fixed */
                                         /*   1 =  Color ramp is programmable */
#define VBE_RsvdBitsUsableMask    0x02   /*  D1 =  Bits in Rsvd field are usable/reserved */
                                         /*   0 =  Bits in Rsvd field are reserved */
                                         /*   1 =  Bits in Rsvd field are usable by the application */

/* CRTCInfoBlock Flags */
#define VBE_GrModeDblScanMask     0x01   /*  D0 =  Double Scan Mode Enable */
                                         /*   0 =  Graphics mode is not double scanned */
                                         /*   1 =  Graphics mode is double scanned */
#define VBE_GrModeInterlMask      0x02   /*  D1 =  Interlaced Mode Enable */
                                         /*   0 =  Graphics mode is non-interlaced */
                                         /*   1 =  Graphics mode is interlaced */
#define VBE_HorSncPolNegMask      0x04   /*  D2 =  Horizontal sync polarity */
                                         /*   0 =  Horizontal sync polarity is positive (+) */
                                         /*   1 =  Horizontal sync polarity is negative (-) */
#define VBE_VerSncPolNegMask      0x08   /*  D3 =  Vertical sync polarity */
